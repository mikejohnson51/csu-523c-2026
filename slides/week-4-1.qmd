...
- Spatial phenomena can be thought of as discrete **objects** with clear boundaries or as **continuous phenomena** that can be observed everywhere, with _no_ natural boundaries.
...
- Like `sf`, `terra` is an implementation of [the standard raster data model](https://gistbok.ucgis.org/bok-topics/raster-data-model)
...
knitr::include_graphics('img/17-raster-tess.png')
```
...
knitr::include_graphics('img/17-pixel-resolution.png')
```
:::
::: {.column width="50%"}
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-what-is-a-pixel.jpg')
```
:::
:::
...
::: {.column width="50%"}
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-boat-res1.jpg')
```
:::
::: {.column width="50%"}
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-boat-res2.jpg')
```
:::
:::
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-lc-pixels.png')
```
::: 
::: {.column width="50%"}
### Continuous Values (numeric)
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-raster-elev.png')
```
:::
:::
...
```{r, fig.align='center',  echo = FALSE}
knitr::include_graphics('img/17-rgb.png')
```
...
```{r, fig.align='center',  echo = FALSE}
knitr::include_graphics('img/17-raster.png')
```
...
::: {.column width="50%"}
```{r, fig.align='center',  echo = FALSE}
knitr::include_graphics('img/17-raster-res.png')
```
:::
::: {.column width="50%"}
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-raster-res.gif')
```
:::
:::
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-rasterize-world.png')
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics('img/17-raster-extent.png')
```
...
knitr::include_graphics('img/17_multi-band.png')
```
...
knitr::include_graphics('img/18-geom-extent.png')
```
...
knitr::include_graphics('img/18-color-picker.png')
```
...
knitr::include_graphics('img/19-sinuosity.png')
```
...
- For more complicated object zones, [exactextractr](https://github.com/isciences/exactextractr) is a fast and efficient R utility that binds the C++ `exactextract` tool. 
...
- Fall back to [GDAL](https://gdal.org/en/stable/programs/gdalwarp.html)
