...
2. Search for **`mikejohnson51/csu-ess-523c-2026`** and **star** the repository — this bookmarks it for you and helps me find your account
...
## Publish via GitHub Pages (recommended: simple main → docs workflow)
...
Notes:
- Do not push student work to the instructor's repo — use your own repo and `main` branch.
- If you cannot publish to Pages, upload a ZIP containing `lab-01.html`, `data/`, `images/`, `session-info.txt`, and `README.md` instead.
